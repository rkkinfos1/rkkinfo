...
filter :emp_no
 ...
 form do |f|
  ...
  f.input :e_mail
  f.input :phone
  f.input :plan, :as => :select, :collection => ['One Time service ($79)','One Time service ($99)','Six Months service ($129)','One Year service ($179)','One Year service ($199)','One Year service SOHO Plan($259)','One Year service SOHO Plan ($279)']
  f.input :technician
  f.input :issue
